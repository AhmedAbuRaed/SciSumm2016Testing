...
/**
 * Created by Ahmed on 2/2/17.
 */
public class RawDocumentsMain {
    public static String workingDir;

    public static void RawDocumentsMainRun(String args[]) {
        if (args.length == 7) {
            ...
            HashMap<String, Document> annotatedRCDocuments;
            HashMap<String, Document> drInventerProcessedRCDocuments;
            HashMap<String, Document> tokenLemmasBNKindFilledRCDocuments;
            HashMap<String, Document> gappVectorsRCDocuments;
            HashMap<String, Document> corefChainsRCDocuments;
            HashMap<String, Document> gappNormalizedVectorsRCDocuments;
            HashMap<String, Document> cosineSimilaritiesRCDocuments;
            HashMap<String, Document> ProcessedRCDocuments;
            ...
            Document d = annotatedRCDocuments.get(rfolderName);
            d.getAnnotations("GS_REFERENCES").clear();
            annotatedRCDocuments.put(rfolderName, d);
            /////////////////////////////
            annotationV3List = Utilities.extractAnnotationsV3FromBaseFolder(new File(baseFolder), true);
            annotatedRCDocuments = Utilities.applyGSAnnotations(annotatedRCDocuments, annotationV3List);
            ///////////////////////////////
            ...
            System.out.println(rfolderName + " Start applying Token Lemmas Babelnet Kind Filling on the documents ...");
            tokenLemmasBNKindFilledRCDocuments = Utilities.applyTokenLemmasBNKindFilling(drInventerProcessedRCDocuments);
            System.out.println(rfolderName + " Token Lemmas Babelnet Kinds Filled ...");
            System.out.println(rfolderName + " Start applying Vectors annotations on the documents ...");
            gappVectorsRCDocuments = Utilities.applyGappVectors(tokenLemmasBNKindFilledRCDocuments);
            System.out.println(rfolderName + " Vectors annotations applied ...");
            System.out.println(rfolderName + " Start applying CoRefChains on the documents ...");
            corefChainsRCDocuments = Utilities.applyCoRefChainsConnectionsonVectors(gappVectorsRCDocuments);
            System.out.println(rfolderName + " Done applying CoRefChains on the documents ...");
            System.out.println(rfolderName + " Start applying Normalized Vectors annotations on the documents ...");
            gappNormalizedVectorsRCDocuments = Utilities.applyGappNormalizedVectors(corefChainsRCDocuments);
            System.out.println(rfolderName + " Normalized Vectors annotations applied ...");
            System.out.println(rfolderName + " Start applying Cosine Similarities annotations on the documents ...");
            cosineSimilaritiesRCDocuments = Utilities.applyCosineSimilarities(gappNormalizedVectorsRCDocuments, new File(rfolderName));
            System.out.println(rfolderName + " Cosine Similarities annotations applied ...");
            System.out.println(rfolderName + " Start applying Babelnet Cosine Similarities annotations on the documents ...");
            ProcessedRCDocuments = Utilities.applyBabelnetCosineSimilarities(cosineSimilaritiesRCDocuments, new File(rfolderName));
            System.out.println(rfolderName + " Babelnet Cosine Similarities annotations applied ...");
            System.gc();
                                ...
                                if (generateTraining) {
                                    ...
                                    if (validCosine) {
                                        try {
                                            ...
                                            System.out.println("Filter Applied...");
*/
                                            Instances classifiedMatchTestInstance = Utilities.classifyInstances(matchTestInstance, matchInputMappedClassifier);
            ...
            Utilities.exportGATEDocuments(ProcessedRCDocuments, rfolderName, outputFolder);

            if (generateTraining) {
                FeatureGenerator.generateMatchARFFfromFeaturesAnnotations(ProcessedRCDocuments, dataStructuresFolder, rfolderName, generateTraining);
                FeatureGenerator.generateFacetARFFfromFeaturesAnnotations(ProcessedRCDocuments, dataStructuresFolder, rfolderName, generateTraining);
            } else {
                FeatureGenerator.generateMatchARFFfromFeaturesAnnotations(ProcessedRCDocuments, dataStructuresFolder, rfolderName, generateTraining);
                FeatureGenerator.generateFacetARFFfromFeaturesAnnotations(ProcessedRCDocuments, dataStructuresFolder, rfolderName, generateTraining);
            }
