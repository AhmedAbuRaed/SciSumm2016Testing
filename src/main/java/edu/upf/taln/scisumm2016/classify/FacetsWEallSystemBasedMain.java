 ...
 */
public class FacetsWEallSystemBasedMain {
    public static String workingDir;

    public static void FacetsWEallSystemMainRun(String args[]) {
        if (args.length == 5) {
            ...
            if (!generateTraining) {
                ...
                ProcessedRCDocuments = Utilities.spitOutOutputAnnotations(output, ProcessedRCDocuments, rfolderName, 2, String.valueOf(0.22), outputFolder);
            }
